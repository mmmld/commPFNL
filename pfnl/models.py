...
class Cooperative(models.Model):
    ...
    offered_product_2 = models.CharField("Produit offert 2", max_length=10, choices=PRODUCT_TYPES["fr"], default="None")
...
class Product(models.Model):
    ...
    def __str__(self):
        return PRODUCT_TYPES["fr"][self.prod_type]
...
class ArtemisiaProduct(models.Model):
    ...
    prod_type = models.CharField("Type de produit", max_length=10, choices=ARTEMISIA_PRODUCTS["fr"], default="None")
    quantity = models.IntegerField("Quantité", default=0)
    price = models.IntegerField("Prix", default=0)
    last_modified = models.DateField("Dernière modification", auto_now_add=True)
    def __str__(self):
        return ARTEMISIA_PRODUCTS["fr"][self.prod_type]
